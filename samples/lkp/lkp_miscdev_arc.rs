//! Rust miscdev registration with read implementation and arc shared state.
...
impl kernel::Module for Lkp {
    fn init(name: &'static CStr, _module: &'static ThisModule) -> Result<Self> {
        let dev_state = Arc::try_new(DevState { number: 1 })?;
        Ok(Lkp {
