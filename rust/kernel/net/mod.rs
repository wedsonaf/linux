...
/// Returns the network namspace for the `init` process.
...
impl SkBuff {
    ...
    #[allow(dead_code)] // TODO: Remove once netfilter code is merged.
    pub(crate) unsafe fn from_ptr<'a>(ptr: *const bindings::sk_buff) -> &'a SkBuff {
